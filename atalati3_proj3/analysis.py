...
arr = []
for i in xrange(42):
    arr.append(create_mapper(["b","x","o"]))

arr.append(create_mapper(["win", "draw", "loss"]))
...
connect4converters = {
    ...
    8: lambda x: arr[8][x],
    9: lambda x: arr[9][x],
    10: lambda x: arr[10][x],
    11: lambda x: arr[11][x],
    12: lambda x: arr[12][x],
    13: lambda x: arr[13][x],
    14: lambda x: arr[14][x],
    15: lambda x: arr[15][x],
    16: lambda x: arr[16][x],
    17: lambda x: arr[17][x],
    18: lambda x: arr[18][x],
    19: lambda x: arr[19][x],
    20: lambda x: arr[20][x],
    21: lambda x: arr[21][x],
    22: lambda x: arr[22][x],
    23: lambda x: arr[23][x],
    24: lambda x: arr[24][x],
    25: lambda x: arr[25][x],
    26: lambda x: arr[26][x],
    27: lambda x: arr[27][x],
    28: lambda x: arr[28][x],
    29: lambda x: arr[29][x],
    30: lambda x: arr[30][x],
    31: lambda x: arr[31][x],
    32: lambda x: arr[32][x],
    33: lambda x: arr[33][x],
    34: lambda x: arr[34][x],
    35: lambda x: arr[35][x],
    36: lambda x: arr[36][x],
    37: lambda x: arr[37][x],
    38: lambda x: arr[38][x],
    39: lambda x: arr[39][x],
    40: lambda x: arr[40][x],
    41: lambda x: arr[41][x],
    42: lambda x: arr[42][x]
}

hr = {}
mammographicMassesDataSetConverters = {}

converters = {"HRset": hr, "mammographic_masses": mammographicMassesDataSetConverters}
